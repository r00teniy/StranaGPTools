...
internal class BuildInAdditionalEducationModel : IBuildingParameters
{
    public double FloorArea { get; set; }
    public int NumberOfPersonel { get; set; }
    public int NumberOfStudents { get; set; }
    public BuildInAdditionalEducationModel(Dictionary<string, string> attributes, string[] attributeNames)
    {
